...
public class SaintTest {
    ...
    @Test
    public void testeDePerderVidaComValor2000()throws Exception{
        GoldSaint bruno = new GoldSaint("Bruno", new Armadura(new Constelacao("Touro"), Categoria.OURO));
    ...
    @Test
    public void verSeOSaintAprendeOGolpe() throws Exception {
         GoldSaint bruno = new GoldSaint("Bruno", new Armadura(new Constelacao("Touro"), Categoria.OURO));
         bruno.aprenderGolpe(new Golpe("voadora", 10));
         assertEquals(1, bruno.getGolpes().size());
    }
    @Test
